...
transactionRouter.post('/', function (request, response) {
    try {
        ...
        var createdTransaction = new CreateTransactionService_1.default(transactionsRepository);
        var transaction = createdTransaction.execute({ title: title, value: value, type: type });
